...
class Dense_Spectral(core.Dense):
    ...
    def __init__(self,
        ...
        super(Dense_Spectral, self).__init__(
...
class Conv2D_Spectral(tf_convolutional_layers.Conv2D, Layer):
    ...
    def __init__(self,
        ...
        super(Conv2D_Spectral, self).__init__(
            filters=filters,
    ...
    def get_config(self):
        ...
        base_config = super(Conv2D_Spectral, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))


@tf_export('keras.layers.Conv2DTranspose',
           'keras.layers.Convolution2DTranspose')
class Conv2DTranspose_Spectral(tf_convolutional_layers.Conv2DTranspose, Layer):
    ...
    def __init__(self,
        ...
        if data_format is None:
            data_format = K.image_data_format()
        super(Conv2DTranspose_Spectral, self).__init__(
            filters=filters,
            kernel_size=kernel_size,
            strides=strides,
            padding=padding,
...
Convolution2D = Conv2D_Spectral
Convolution2DTranspose = Conv2DTranspose_Spectral
Deconvolution2D = Deconv2D = Conv2DTranspose_Spectral
